...
plot(post_samples$samples[, c("S[23]")], bty = "n", main = "S[23]")
plot(post_samples$samples[, c("S[45]")], bty = "n", main = "S[45]")
plot(post_samples$samples[, c("S[60]")], bty = "n", main = "S[60]")
plot(post_samples$samples[, c("p[1]")], bty = "n", main = "p[1]")
plot(post_samples$samples[, c("p[13]")], bty = "n", main = "p[13]")
plot(post_samples$samples[, c("p[50]")], bty = "n", main = "p[50]")
...
ggplot(data = post_sum_S, aes(x = village)) +
  ...
  theme_clear() + theme(axis.text.x = element_text(angle = 90)) + 
  ylab("") + xlab("village") + ggtitle("Posterior summary spatial random effect by village")
...
ggplot(data = post_sum_p, aes(x = village)) +
  geom_pointrange(aes(ymin = `95%CI_low`, ymax = `95%CI_upp`, y = Mean)) +
  theme_clear() + theme(axis.text.x = element_text(angle = 90)) + 
  ylab("") + xlab("village") + ggtitle("Posterior summary probabilities by village")
