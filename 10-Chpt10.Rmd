...
```{r Ex 10.9 plot predictions}


Mtl_shape <- readOGR("data/montreal_shp/temp1.shp")

Mtl_centroids_df$mean_benzene <- rowMeans(spatial_pred_MTL)

ggplot(Mtl_centroids_df) + 
  geom_point(aes(x = easting, y = northing, color = mean_benzene), size = 10) + 
  theme_void()
