...
print0("ESS a: ", coda::effectiveSize(a[seqaux]))
print0("ESS b: ", coda::effectiveSize(b[seqaux]))
print0("ESS theta[1]: ", coda::effectiveSize(theta[seqaux, 1]))
print0("ESS theta[10]: ",coda::effectiveSize(theta[seqaux, 10]))
