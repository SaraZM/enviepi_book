...
```{r Ex 8.3 nimble car run}

# Defining the constants, data and initial values list
...
Data_CAR = list(y = observed$Y2010)
Inits_CAR = list(
  beta0 = rnorm(1),
  fitted = rpois(N, 2),
  sigma_b = 1,
...
# Traceplots for some of the parameters 
...
```{r Ex 8.3 stan CAR summary, results='asis'}
