...
SMRspatial_raw <- merge(england, SMR_raw, by = "ID") # Database file
...
ggplot() + 
  geom_sf(data = SMRspatial_raw, aes(fill = SMR2010)) + # Choose spatial object and column for plotting
  scale_y_continuous(breaks = range) + # Break points for colours 
  theme(axis.text.x = element_blank(), # Clear background and plot borders
...
SMRspatial_smooth <- merge(england, SMR_smooth, by = "ID")        # Database file

ggplot() + 
  geom_sf(data = SMRspatial_smooth, aes(fill = SMR2010)) + # Choose spatial object and column for plotting
  scale_y_continuous(breaks = range) + # Break points for colours 
  theme(axis.text.x = element_blank(), # Clear background and plot borders
        axis.text.y = element_blank(),
        axis.ticks = element_blank(),
