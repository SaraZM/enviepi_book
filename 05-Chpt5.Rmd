...
For this example, the following packages are needed `ggplot2, sf` and `nimble`.
...
```{r Ex 5.2 map, class.source = 'foldable', fig.align = 'center'}
...
```{r Ex 5.2 MCMC posterior summary, fig.align = 'center', fig.align = 'center'}
...
```{r Ex 5.2 posterior summary nimble}
